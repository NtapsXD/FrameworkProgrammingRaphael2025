...
class Warga(models.Model):
    ...
    # Field ini sempat error sebelumnya, pastikan ada:
...
class Pengaduan(models.Model):
    ...
    # Pastikan nama fieldnya adalah 'tanggal_lapor' (bukan 'tanggal')
    tanggal_lapor = models.DateTimeField(auto_now_add=True)
    
    # --- BAGIAN PENTING (YANG ERROR) ---
    # Pastikan baris ini ADA dan namanya 'pelapor'
